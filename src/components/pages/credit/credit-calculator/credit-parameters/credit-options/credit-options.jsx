      ...
      <ul className="credit-options__list">
        {creditType === CreditType.MORTGAGE &&
          <li className="credit-options__item">
            <input className="credit-options__input visually-hidden" type="checkbox" id="maternal-capital" name="maternal-capital"
        ...
        {creditType === CreditType.CAR && <>
          <li className="credit-options__item">
            <input className="credit-options__input visually-hidden" type="checkbox" id="casco" name="casco"
          ...
          <li className="credit-options__item">
            <input className="credit-options__input visually-hidden" type="checkbox" id="life-insurance" name="life-insurance"
